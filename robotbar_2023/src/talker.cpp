...
{
	ros::init(argc, argv, "talker",ros::InitOption::AnonymousName);//1.初始化 ROS 並為node命名,talker為node名稱  2.ros::InitOption::AnonymousName 發佈時加上時間

	ros::NodeHandle n;//node 初始化,n為變數名稱
